...
import 'package:flutter_demo_list/routers/NavigatorUtil.dart';
                        ...
                        child: Column(children: <Widget>[
                          Text(
                            ...
                            style: TextStyle(
                                ...
                                color: Color.fromRGBO(19, 18, 18, 1)),
                          ),
                          Text(
                            '${item['sub-title']}',
                            style: TextStyle(
                    ...
                    itemBuilder: (BuildContext context, int index) =>
                        new Container(
                            ...
                            child: new Center(
                              ...
                              children: <Widget>[
                                Image.network(
                                  'https://free.modao.cc/uploads4/images/3984/39841665/v2_pyhhbc.png',
        ...
        children: <Widget>[
          ...
          Row(
            children: <Widget>[
              ...
              Text(
                '8999',
                style: TextStyle(fontSize: ScreenUtil().setSp(24), height: 1.3),
              )
            ],
          ),
          Row(
            ...
            return Container(
                ...
                child: Column(children: [
                  ...
                  Text(
                    '${item['label']}',
                    style: TextStyle(
                        fontSize: ScreenUtil().setSp(22), color: Colors.grey),
                  )
                ]));
          }).toList(),
        ));
